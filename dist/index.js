...
var require_shared = __commonJS({
  "node_modules/sync-fetch/shared.js"(exports2, module2) {
    ...
    function deserializeResponse(fetch2, body, init, bodyError) {
      ...
      return new fetch2.Response(body ? createStream(buffer) : createStream(null), {
        ...init,
        headers: deserializeHeaders(fetch2, init.headers)
      }, {
        buffer,
...
var require_sync_fetch = __commonJS({
  "node_modules/sync-fetch/index.js"(exports2, module2) {
    ...
    function fetch2(resource, init) {
      ...
      } else if (resource instanceof URL3) {
...
var require_errors = __commonJS({
  "node_modules/fake-indexeddb/build/lib/errors.js"(exports2) {
    "use strict";
...
var require_valueToKey = __commonJS({
  "node_modules/fake-indexeddb/build/lib/valueToKey.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    ...
    exports2.default = valueToKey;
  }
});

// node_modules/fake-indexeddb/build/lib/cmp.js
var require_cmp = __commonJS({
  "node_modules/fake-indexeddb/build/lib/cmp.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var errors_1 = require_errors();
...
var require_FDBKeyRange = __commonJS({
  "node_modules/fake-indexeddb/build/FDBKeyRange.js"(exports2) {
    ...
    var FDBKeyRange = function() {
      function FDBKeyRange2(lower, upper, lowerOpen, upperOpen) {
        this.lower = lower;
        this.upper = upper;
        this.lowerOpen = lowerOpen;
        this.upperOpen = upperOpen;
      }
      FDBKeyRange2.only = function(value) {
        if (arguments.length === 0) {
          throw new TypeError();
        }
        value = valueToKey_1.default(value);
        return new FDBKeyRange2(value, value, false, false);
      };
      FDBKeyRange2.lowerBound = function(lower, open) {
        if (open === void 0) {
          open = false;
        }
        if (arguments.length === 0) {
        ...
        return new FDBKeyRange2(lower, void 0, open, true);
      };
      FDBKeyRange2.upperBound = function(upper, open) {
        if (open === void 0) {
          open = false;
        }
        if (arguments.length === 0) {
        ...
        return new FDBKeyRange2(void 0, upper, true, open);
      };
      FDBKeyRange2.bound = function(lower, upper, lowerOpen, upperOpen) {
        if (lowerOpen === void 0) {
          lowerOpen = false;
        }
        if (upperOpen === void 0) {
        ...
        lower = valueToKey_1.default(lower);
        upper = valueToKey_1.default(upper);
        return new FDBKeyRange2(lower, upper, lowerOpen, upperOpen);
      };
      FDBKeyRange2.prototype.includes = function(key) {
        if (arguments.length === 0) {
          throw new TypeError();
        }
      ...
      FDBKeyRange2.prototype.toString = function() {
        return "[object IDBKeyRange]";
      };
      return FDBKeyRange2;
    }();
    exports2.default = FDBKeyRange;
  }
});

// node_modules/fake-indexeddb/build/lib/extractKey.js
var require_extractKey = __commonJS({
  "node_modules/fake-indexeddb/build/lib/extractKey.js"(exports2) {
    "use strict";
    ...
    exports2.default = extractKey;
  }
});

// node_modules/realistic-structured-clone/dist/index.js
var require_dist = __commonJS({
  "node_modules/realistic-structured-clone/dist/index.js"(exports2, module2) {
    (function(f) {
      ...
      return function() {
        ...
        module4.exports = realisticStructuredClone;
      }, { "core-js/fn/array/includes": 2, "core-js/fn/object/values": 3, "domexception": 46, "typeson": 49, "typeson-registry/dist/presets/structured-cloning-throwing": 48 }], 2: [function(_dereq_, module4, exports4) {
        "use strict";
        _dereq_("../../modules/es7.array.includes");
        module4.exports = _dereq_("../../modules/_core").Array.includes;
      }, { "../../modules/_core": 9, "../../modules/es7.array.includes": 41 }], 3: [function(_dereq_, module4, exports4) {
        "use strict";
        _dereq_("../../modules/es7.object.values");
        module4.exports = _dereq_("../../modules/_core").Object.values;
      }, { "../../modules/_core": 9, "../../modules/es7.object.values": 42 }], 4: [function(_dereq_, module4, exports4) {
        "use strict";
      ...
      }, { "./_hide": 20, "./_wks": 40 }], 6: [function(_dereq_, module4, exports4) {
        "use strict";
      ...
      }, { "./_is-object": 23 }], 7: [function(_dereq_, module4, exports4) {
        "use strict";
        var toIObject = _dereq_("./_to-iobject");
        var toLength = _dereq_("./_to-length");
        var toAbsoluteIndex = _dereq_("./_to-absolute-index");
        module4.exports = function(IS_INCLUDES) {
      ...
      }, { "./_to-absolute-index": 34, "./_to-iobject": 36, "./_to-length": 37 }], 8: [function(_dereq_, module4, exports4) {
        "use strict";
        var toString = {}.toString;
        module4.exports = function(it) {
          return toString.call(it).slice(8, -1);
        };
      }, {}], 9: [function(_dereq_, module4, exports4) {
        "use strict";
        var core = module4.exports = { version: "2.6.12" };
        if (typeof __e == "number")
          __e = core;
      }, {}], 10: [function(_dereq_, module4, exports4) {
        "use strict";
        var aFunction = _dereq_("./_a-function");
        module4.exports = function(fn, that, length) {
          aFunction(fn);
          if (that === void 0)
            return fn;
          switch (length) {
      ...
      }, { "./_a-function": 4 }], 11: [function(_dereq_, module4, exports4) {
        "use strict";
        module4.exports = function(it) {
          if (it == void 0)
      ...
      }, {}], 12: [function(_dereq_, module4, exports4) {
        "use strict";
        module4.exports = !_dereq_("./_fails")(function() {
          return Object.defineProperty({}, "a", { get: function get() {
            return 7;
          } }).a != 7;
        });
      }, { "./_fails": 16 }], 13: [function(_dereq_, module4, exports4) {
        "use strict";
        var isObject = _dereq_("./_is-object");
        var document2 = _dereq_("./_global").document;
        var is = isObject(document2) && isObject(document2.createElement);
        module4.exports = function(it) {
          return is ? document2.createElement(it) : {};
        };
      }, { "./_global": 18, "./_is-object": 23 }], 14: [function(_dereq_, module4, exports4) {
        "use strict";
        module4.exports = "constructor,hasOwnProperty,isPrototypeOf,propertyIsEnumerable,toLocaleString,toString,valueOf".split(",");
      }, {}], 15: [function(_dereq_, module4, exports4) {
        "use strict";
        var global2 = _dereq_("./_global");
        ...
        $export.U = 64;
        $export.R = 128;
        module4.exports = $export;
      }, { "./_core": 9, "./_ctx": 10, "./_global": 18, "./_hide": 20, "./_redefine": 31 }], 16: [function(_dereq_, module4, exports4) {
        "use strict";
      ...
      }, {}], 17: [function(_dereq_, module4, exports4) {
        "use strict";
        module4.exports = _dereq_("./_shared")("native-function-to-string", Function.toString);
      }, { "./_shared": 33 }], 18: [function(_dereq_, module4, exports4) {
        "use strict";
        var global2 = module4.exports = typeof window != "undefined" && window.Math == Math ? window : typeof self != "undefined" && self.Math == Math ? self : Function("return this")();
        if (typeof __g == "number")
          __g = global2;
      }, {}], 19: [function(_dereq_, module4, exports4) {
        "use strict";
        var hasOwnProperty = {}.hasOwnProperty;
        module4.exports = function(it, key) {
          return hasOwnProperty.call(it, key);
        };
      }, {}], 20: [function(_dereq_, module4, exports4) {
        "use strict";
        var dP = _dereq_("./_object-dp");
        var createDesc = _dereq_("./_property-desc");
        module4.exports = _dereq_("./_descriptors") ? function(object, key, value) {
          return dP.f(object, key, createDesc(1, value));
        } : function(object, key, value) {
          object[key] = value;
          return object;
        };
      }, { "./_descriptors": 12, "./_object-dp": 25, "./_property-desc": 30 }], 21: [function(_dereq_, module4, exports4) {
        "use strict";
        module4.exports = !_dereq_("./_descriptors") && !_dereq_("./_fails")(function() {
          return Object.defineProperty(_dereq_("./_dom-create")("div"), "a", { get: function get() {
            return 7;
          } }).a != 7;
        });
      }, { "./_descriptors": 12, "./_dom-create": 13, "./_fails": 16 }], 22: [function(_dereq_, module4, exports4) {
        "use strict";
        var cof = _dereq_("./_cof");
        module4.exports = Object("z").propertyIsEnumerable(0) ? Object : function(it) {
          return cof(it) == "String" ? it.split("") : Object(it);
        };
      }, { "./_cof": 8 }], 23: [function(_dereq_, module4, exports4) {
        "use strict";
      ...
      }, {}], 24: [function(_dereq_, module4, exports4) {
        "use strict";
        module4.exports = false;
      }, {}], 25: [function(_dereq_, module4, exports4) {
        "use strict";
        var anObject = _dereq_("./_an-object");
        var IE8_DOM_DEFINE = _dereq_("./_ie8-dom-define");
        var toPrimitive = _dereq_("./_to-primitive");
        var dP = Object.defineProperty;
        exports4.f = _dereq_("./_descriptors") ? Object.defineProperty : function defineProperty(O, P, Attributes) {
          anObject(O);
      ...
      }, { "./_an-object": 6, "./_descriptors": 12, "./_ie8-dom-define": 21, "./_to-primitive": 38 }], 26: [function(_dereq_, module4, exports4) {
        "use strict";
      ...
      }, { "./_array-includes": 7, "./_has": 19, "./_shared-key": 32, "./_to-iobject": 36 }], 27: [function(_dereq_, module4, exports4) {
        "use strict";
      ...
      }, { "./_enum-bug-keys": 14, "./_object-keys-internal": 26 }], 28: [function(_dereq_, module4, exports4) {
        "use strict";
        exports4.f = {}.propertyIsEnumerable;
      }, {}], 29: [function(_dereq_, module4, exports4) {
        "use strict";
        var DESCRIPTORS = _dereq_("./_descriptors");
        var getKeys = _dereq_("./_object-keys");
        var toIObject = _dereq_("./_to-iobject");
        var isEnum = _dereq_("./_object-pie").f;
        module4.exports = function(isEntries) {
          return function(it) {
            var O = toIObject(it);
            var keys = getKeys(O);
      ...
      }, { "./_descriptors": 12, "./_object-keys": 27, "./_object-pie": 28, "./_to-iobject": 36 }], 30: [function(_dereq_, module4, exports4) {
        "use strict";
      ...
      }, {}], 31: [function(_dereq_, module4, exports4) {
        "use strict";
        var global2 = _dereq_("./_global");
        var hide = _dereq_("./_hide");
        var has = _dereq_("./_has");
        ...
        (module4.exports = function(O, key, val, safe) {
      ...
      }, { "./_core": 9, "./_function-to-string": 17, "./_global": 18, "./_has": 19, "./_hide": 20, "./_uid": 39 }], 32: [function(_dereq_, module4, exports4) {
        "use strict";
      ...
      }, { "./_shared": 33, "./_uid": 39 }], 33: [function(_dereq_, module4, exports4) {
        "use strict";
        var core = _dereq_("./_core");
        var global2 = _dereq_("./_global");
      ...
      }, { "./_core": 9, "./_global": 18, "./_library": 24 }], 34: [function(_dereq_, module4, exports4) {
        "use strict";
      ...
      }, { "./_to-integer": 35 }], 35: [function(_dereq_, module4, exports4) {
        "use strict";
        var ceil = Math.ceil;
      ...
      }, {}], 36: [function(_dereq_, module4, exports4) {
        "use strict";
      ...
      }, { "./_defined": 11, "./_iobject": 22 }], 37: [function(_dereq_, module4, exports4) {
        "use strict";
        var toInteger = _dereq_("./_to-integer");
        var min = Math.min;
        module4.exports = function(it) {
      ...
      }, { "./_to-integer": 35 }], 38: [function(_dereq_, module4, exports4) {
        "use strict";
        var isObject = _dereq_("./_is-object");
        module4.exports = function(it, S) {
          if (!isObject(it))
            return it;
          var fn, val;
      ...
      }, { "./_is-object": 23 }], 39: [function(_dereq_, module4, exports4) {
        "use strict";
        var id = 0;
        var px = Math.random();
        module4.exports = function(key) {
      ...
      }, {}], 40: [function(_dereq_, module4, exports4) {
        "use strict";
        var store = _dereq_("./_shared")("wks");
        var uid = _dereq_("./_uid");
        var _Symbol = _dereq_("./_global").Symbol;
        var USE_SYMBOL = typeof _Symbol == "function";
        var $exports = module4.exports = function(name) {
          return store[name] || (store[name] = USE_SYMBOL && _Symbol[name] || (USE_SYMBOL ? _Symbol : uid)("Symbol." + name));
        };
        $exports.store = store;
      }, { "./_global": 18, "./_shared": 33, "./_uid": 39 }], 41: [function(_dereq_, module4, exports4) {
        "use strict";
      ...
      }, { "./_add-to-unscopables": 5, "./_array-includes": 7, "./_export": 15 }], 42: [function(_dereq_, module4, exports4) {
        "use strict";
        var $export = _dereq_("./_export");
      ...
      }, { "./_export": 15, "./_object-to-array": 29 }], 43: [function(_dereq_, module4, exports4) {
        "use strict";
        ...
        exports4.implementation = function() {
        ...
        exports4.init = function(impl) {
          if (Error.captureStackTrace) {
            var wrapper = idlUtils.wrapperForImpl(impl);
            Error.captureStackTrace(wrapper, wrapper.constructor);
          }
        };
      }, { "./legacy-error-codes.json": 45, "./utils.js": 47 }], 44: [function(_dereq_, module4, exports4) {
        "use strict";
        ...
        var iface = {
          ...
          is: function is(obj) {
            if (obj) {
              ...
              for (var i = 0; i < module4.exports.mixedInto.length; ++i) {
                if (obj instanceof module4.exports.mixedInto[i]) {
                  return true;
                }
              }
            }
          ...
          isImpl: function isImpl(obj) {
            if (obj) {
              ...
              for (var i = 0; i < module4.exports.mixedInto.length; ++i) {
                if (wrapper instanceof module4.exports.mixedInto[i]) {
                  return true;
                }
              }
            }
        ...
        module4.exports = iface;
        var Impl = _dereq_(".//DOMException-impl.js");
      }, { ".//DOMException-impl.js": 43, "./utils.js": 47, "webidl-conversions": 50 }], 45: [function(_dereq_, module4, exports4) {
        module4.exports = {
          "IndexSizeError": 1,
      ...
      }, {}], 46: [function(_dereq_, module4, exports4) {
        "use strict";
        module4.exports = _dereq_("./DOMException").interface;
        Object.setPrototypeOf(module4.exports.prototype, Error.prototype);
      }, { "./DOMException": 44 }], 47: [function(_dereq_, module4, exports4) {
        "use strict";
        var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function(obj) {
          return typeof obj;
        } : function(obj) {
      ...
      }, {}], 48: [function(_dereq_, module4, exports4) {
        "use strict";
        ...
        !function(e, t) {
          (typeof exports4 === "undefined" ? "undefined" : _typeof2(exports4)) == "object" && typeof module4 != "undefined" ? module4.exports = t() : typeof define2 == "function" && define2.amd ? define2(t) : ((e = typeof globalThis != "undefined" ? globalThis : e || self).Typeson = e.Typeson || {}, e.Typeson.presets = e.Typeson.presets || {}, e.Typeson.presets.structuredCloningThrowing = t());
        }(void 0, function() {
          "use strict";
          function _typeof$1(e2) {
            return (_typeof$1 = typeof Symbol == "function" && _typeof2(Symbol.iterator) == "symbol" ? function(e3) {
              return typeof e3 === "undefined" ? "undefined" : _typeof2(e3);
            } : function(e3) {
              return e3 && typeof Symbol == "function" && e3.constructor === Symbol && e3 !== Symbol.prototype ? "symbol" : typeof e3 === "undefined" ? "undefined" : _typeof2(e3);
            })(e2);
          }
          ...
          function _typeof(e2) {
            return (_typeof = typeof Symbol == "function" && _typeof2(Symbol.iterator) == "symbol" ? function _typeof3(e3) {
              return typeof e3 === "undefined" ? "undefined" : _typeof2(e3);
      ...
      }, {}], 49: [function(_dereq_, module4, exports4) {
        "use strict";
        var _typeof2 = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function(obj) {
          return typeof obj;
        } : function(obj) {
        ...
        function _typeof(e2) {
          return (_typeof = typeof Symbol == "function" && _typeof2(Symbol.iterator) == "symbol" ? function(e3) {
            return typeof e3 === "undefined" ? "undefined" : _typeof2(e3);
          } : function(e3) {
            return e3 && typeof Symbol == "function" && e3.constructor === Symbol && e3 !== Symbol.prototype ? "symbol" : typeof e3 === "undefined" ? "undefined" : _typeof2(e3);
          })(e2);
        ...
        function hasConstructorOf(e2, t2) {
          ...
          return typeof i2 != "function" ? t2 === null : t2 === i2 || t2 !== null && o.call(i2) === o.call(t2) || typeof t2 == "function" && typeof i2.__typeson__type__ == "string" && i2.__typeson__type__ === t2.__typeson__type__;
        }
        function isPlainObject(e2) {
          return !(!e2 || toStringTag(e2) !== "Object") && (!n(e2) || hasConstructorOf(e2, Object));
        }
          ...
          return function _createClass(e2, t2, r2) {
            ...
            function _encapsulate(t3, r3, o3, s2, u3, h2, v2) {
              ...
              if (["string", "boolean", "number", "undefined"].includes(O))
                return r3 === void 0 || Number.isNaN(r3) || r3 === Number.NEGATIVE_INFINITY || r3 === Number.POSITIVE_INFINITY ? (b2 = s2.replaced ? r3 : replace(t3, r3, s2, u3, false, h2, j)) !== r3 && (_ = { replaced: b2 }) : b2 = r3, j && j(), b2;
              if (r3 === null)
                return j && j(), r3;
              if (o3 && !s2.iterateIn && !s2.iterateUnsetNumeric && r3 && _typeof(r3) === "object") {
                var m = l.indexOf(r3);
                if (!(m < 0))
                  return y[t3] = "#", j && j({ cyclicKeypath: f[m] }), "#" + f[m];
                o3 === true && (l.push(r3), f.push(t3));
              }
              ...
              if (T !== r3 ? (b2 = T, _ = { replaced: T }) : t3 === "" && hasConstructorOf(r3, e) ? (u3.push([t3, r3, o3, s2, void 0, void 0, s2.type]), b2 = r3) : P && s2.iterateIn !== "object" || s2.iterateIn === "array" ? (S = new Array(r3.length), _ = { clone: S }) : (["function", "symbol"].includes(_typeof(r3)) || "toJSON" in r3 || hasConstructorOf(r3, e) || hasConstructorOf(r3, Promise) || hasConstructorOf(r3, ArrayBuffer)) && !g && s2.iterateIn !== "object" ? b2 = r3 : (S = {}, s2.addLength && (S.length = r3.length), _ = { clone: S }), j && j(), n2.iterateNone)
                return S || b2;
              if (!S)
                return b2;
              if (s2.iterateIn) {
                var w = function _loop(n3) {
                  ...
                  _adaptBuiltinStateObjectProperties(s2, a2, function() {
                    ...
                    hasConstructorOf(i2, e) ? u3.push([a3, i2, Boolean(o3), s2, S, n3, s2.type]) : i2 !== void 0 && (S[n3] = i2);
                  });
                };
                for (var A in r3) {
                  w(A);
                ...
                a(r3).forEach(function(n3) {
                  ...
                  _adaptBuiltinStateObjectProperties(s2, { ownKeys: true }, function() {
                    ...
                    hasConstructorOf(t4, e) ? u3.push([a2, t4, Boolean(o3), s2, S, n3, s2.type]) : t4 !== void 0 && (S[n3] = t4);
                  });
            ...
            return hasConstructorOf(h, e) ? f = h.then(function() {
              ...
              if (!u2 || t3 !== "$types") {
                ...
                if (h2 || isPlainObject(r3)) {
                  ...
                  for (a(r3).forEach(function(n3) {
                    var a2 = _revive(t3 + (t3 ? "." : "") + escapeKeyPathComponent(n3), r3[n3], o3 || v, v, n3), i2 = function set(e2) {
                      return hasConstructorOf(e2, p) ? v[n3] = void 0 : e2 !== void 0 && (v[n3] = e2), e2;
                    };
                ...
                if (f2 === "#") {
                  ...
                  return S === void 0 && c2.push([o3, r3.slice(1), s3, y2]), S;
                }
            ...
            return t2 = t2 || {}, [].concat(e2).forEach(function R(e3) {
              ...
              e3 && a(e3).forEach(function(r3) {
                ...
                if (a2.length && (o2.splice(o2.indexOf(a2[0]), 1), delete this.revivers[r3], delete this.types[r3]), typeof n2 == "function") {
                  var c2 = n2;
                  n2 = { test: function test(e4) {
                    return e4 && e4.constructor === c2;
                  }, replace: function replace(e4) {
                ...
                if (n2 && n2.test) {
                  ...
                  var p2 = typeof t2.fallback == "number" ? t2.fallback : t2.fallback ? 0 : Number.POSITIVE_INFINITY;
        ...
        p.__typeson__type__ = "TypesonUndefined", u.Undefined = p, u.Promise = e, u.isThenable = isThenable, u.toStringTag = toStringTag, u.hasConstructorOf = hasConstructorOf, u.isObject = isObject, u.isPlainObject = isPlainObject, u.isUserObject = function isUserObject(e2) {
          ...
          return e2 === null ? "null" : Array.isArray(e2) ? "array" : _typeof(e2);
        }, u.JSON_TYPES = ["null", "boolean", "number", "string", "array", "object"], module4.exports = u;
      }, {}], 50: [function(_dereq_, module4, exports4) {
        "use strict";
        var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function(obj) {
          return typeof obj;
        } : function(obj) {
        ...
        exports4.any = function(V) {
          return V;
        };
        exports4.void = function() {
          return void 0;
        };
        exports4.boolean = function(val) {
          return !!val;
        };
        exports4.byte = createIntegerConversion(8, { unsigned: false });
        exports4.octet = createIntegerConversion(8, { unsigned: true });
        exports4.short = createIntegerConversion(16, { unsigned: false });
        exports4["unsigned short"] = createIntegerConversion(16, { unsigned: true });
        exports4.long = createIntegerConversion(32, { unsigned: false });
        exports4["unsigned long"] = createIntegerConversion(32, { unsigned: true });
        exports4["long long"] = createIntegerConversion(64, { unsigned: false });
        exports4["unsigned long long"] = createIntegerConversion(64, { unsigned: true });
        exports4.double = function(V, opts) {
          var x = +V;
          if (!Number.isFinite(x)) {
        ...
        exports4["unrestricted double"] = function(V) {
          var x = +V;
          return x;
        };
        exports4.float = function(V, opts) {
          var x = +V;
          if (!Number.isFinite(x)) {
            throw new TypeError(_("is not a finite floating-point value", opts));
          }
        ...
        exports4["unrestricted float"] = function(V) {
          var x = +V;
          if (isNaN(x)) {
            return x;
          }
        ...
        exports4.DOMString = function(V, opts) {
          if (opts === void 0) {
            opts = {};
          }
          if (opts.treatNullAsEmptyString && V === null) {
        ...
        exports4.ByteString = function(V, opts) {
          var x = exports4.DOMString(V, opts);
          var c = void 0;
        ...
        exports4.USVString = function(V, opts) {
          var S = exports4.DOMString(V, opts);
          var n = S.length;
          var U = [];
          for (var i = 0; i < n; ++i) {
        ...
        exports4.object = function(V, opts) {
          if (type(V) !== "Object") {
        ...
        exports4.ArrayBufferView = function(V, opts) {
          if (!ArrayBuffer.isView(V)) {
            throw new TypeError(_("is not a view on an ArrayBuffer object", opts));
          }
          return V;
        };
        exports4.BufferSource = function(V, opts) {
          if (!(ArrayBuffer.isView(V) || V instanceof ArrayBuffer)) {
            throw new TypeError(_("is not an ArrayBuffer object or a view on one", opts));
          }
          return V;
        };
        exports4.DOMTimeStamp = exports4["unsigned long long"];
        exports4.Function = convertCallbackFunction;
        exports4.VoidFunction = convertCallbackFunction;
      }, {}] }, {}, [1])(1);
    });
  }
});
...
var require_structuredClone = __commonJS({
  "node_modules/fake-indexeddb/build/lib/structuredClone.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    ...
    exports2.default = structuredClone;
  }
});

// node_modules/fake-indexeddb/build/FDBCursor.js
var require_FDBCursor = __commonJS({
  "node_modules/fake-indexeddb/build/FDBCursor.js"(exports2) {
    "use strict";
    var __values = exports2 && exports2.__values || function(o) {
      var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
      if (m)
    ...
    var FDBCursor = function() {
      function FDBCursor2(source, range, direction, request, keyOnly) {
        if (direction === void 0) {
          direction = "next";
        }
        if (keyOnly === void 0) {
      ...
      Object.defineProperty(FDBCursor2.prototype, "source", {
        get: function() {
          return this._source;
        },
        set: function(val) {
      ...
      Object.defineProperty(FDBCursor2.prototype, "direction", {
        get: function() {
      ...
      Object.defineProperty(FDBCursor2.prototype, "key", {
        get: function() {
          return this._key;
        },
        set: function(val) {
      ...
      Object.defineProperty(FDBCursor2.prototype, "primaryKey", {
        get: function() {
      ...
      FDBCursor2.prototype._iterate = function(key, primaryKey) {
      ...
      FDBCursor2.prototype.update = function(value) {
        if (value === void 0) {
          throw new TypeError();
        }
      ...
      FDBCursor2.prototype.advance = function(count) {
        var _this = this;
      ...
      FDBCursor2.prototype.continue = function(key) {
        var effectiveObjectStore = getEffectiveObjectStore(this);
        var transaction = effectiveObjectStore.transaction;
        if (transaction._state !== "active") {
          throw new errors_1.TransactionInactiveError();
      ...
      FDBCursor2.prototype.continuePrimaryKey = function(key, primaryKey) {
        var effectiveObjectStore = getEffectiveObjectStore(this);
        var transaction = effectiveObjectStore.transaction;
        if (transaction._state !== "active") {
          throw new errors_1.TransactionInactiveError();
      ...
      FDBCursor2.prototype.delete = function() {
        var effectiveObjectStore = getEffectiveObjectStore(this);
        var effectiveKey = this.source.hasOwnProperty("_rawIndex") ? this.primaryKey : this._position;
        var transaction = effectiveObjectStore.transaction;
        if (transaction._state !== "active") {
      ...
      FDBCursor2.prototype.toString = function() {
        return "[object IDBCursor]";
      };
      return FDBCursor2;
    }();
    exports2.default = FDBCursor;
  }
});

// node_modules/fake-indexeddb/build/FDBCursorWithValue.js
var require_FDBCursorWithValue = __commonJS({
  "node_modules/fake-indexeddb/build/FDBCursorWithValue.js"(exports2) {
    "use strict";
    var __extends = exports2 && exports2.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var FDBCursorWithValue = function(_super) {
      __extends(FDBCursorWithValue2, _super);
      function FDBCursorWithValue2(source, range, direction, request) {
        var _this = _super.call(this, source, range, direction, request) || this;
        _this.value = void 0;
        return _this;
      }
      FDBCursorWithValue2.prototype.toString = function() {
        return "[object IDBCursorWithValue]";
      };
      return FDBCursorWithValue2;
    }(FDBCursor_1.default);
    exports2.default = FDBCursorWithValue;
  }
});

// node_modules/fake-indexeddb/build/lib/FakeEventTarget.js
var require_FakeEventTarget = __commonJS({
  "node_modules/fake-indexeddb/build/lib/FakeEventTarget.js"(exports2) {
    "use strict";
    var __values = exports2 && exports2.__values || function(o) {
      var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
      if (m)
    ...
    exports2.default = FakeEventTarget;
  }
});

// node_modules/fake-indexeddb/build/FDBRequest.js
var require_FDBRequest = __commonJS({
  "node_modules/fake-indexeddb/build/FDBRequest.js"(exports2) {
    "use strict";
    var __extends = exports2 && exports2.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var FDBRequest = function(_super) {
      __extends(FDBRequest2, _super);
      function FDBRequest2() {
      ...
      Object.defineProperty(FDBRequest2.prototype, "error", {
        get: function() {
      ...
      Object.defineProperty(FDBRequest2.prototype, "result", {
        get: function() {
          if (this.readyState === "pending") {
            throw new errors_1.InvalidStateError();
          }
      ...
      FDBRequest2.prototype.toString = function() {
        return "[object IDBRequest]";
      };
      return FDBRequest2;
    }(FakeEventTarget_1.default);
    exports2.default = FDBRequest;
  }
});

// node_modules/fake-indexeddb/build/lib/enforceRange.js
var require_enforceRange = __commonJS({
  "node_modules/fake-indexeddb/build/lib/enforceRange.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
var require_fakeDOMStringList = __commonJS({
  "node_modules/fake-indexeddb/build/lib/fakeDOMStringList.js"(exports2) {
    ...
    exports2.default = fakeDOMStringList;
  }
});

// node_modules/fake-indexeddb/build/lib/valueToKeyRange.js
var require_valueToKeyRange = __commonJS({
  "node_modules/fake-indexeddb/build/lib/valueToKeyRange.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var FDBKeyRange_1 = require_FDBKeyRange();
    var errors_1 = require_errors();
    ...
    exports2.default = valueToKeyRange;
  }
});

// node_modules/fake-indexeddb/build/FDBIndex.js
var require_FDBIndex = __commonJS({
  "node_modules/fake-indexeddb/build/FDBIndex.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var FDBCursor_1 = require_FDBCursor();
    ...
    var FDBIndex = function() {
      function FDBIndex2(objectStore, rawIndex) {
      ...
      Object.defineProperty(FDBIndex2.prototype, "name", {
        get: function() {
          return this._name;
        },
        set: function(name) {
      ...
      FDBIndex2.prototype.openCursor = function(range, direction) {
      ...
      FDBIndex2.prototype.openKeyCursor = function(range, direction) {
        confirmActiveTransaction(this);
        if (range === null) {
          range = void 0;
        }
      ...
      FDBIndex2.prototype.get = function(key) {
        confirmActiveTransaction(this);
      ...
      FDBIndex2.prototype.getAll = function(query, count) {
      ...
      FDBIndex2.prototype.getKey = function(key) {
        confirmActiveTransaction(this);
        if (!(key instanceof FDBKeyRange_1.default)) {
          key = valueToKey_1.default(key);
        }
      ...
      FDBIndex2.prototype.getAllKeys = function(query, count) {
        if (arguments.length > 1 && count !== void 0) {
          count = enforceRange_1.default(count, "unsigned long");
        }
        confirmActiveTransaction(this);
      ...
      FDBIndex2.prototype.count = function(key) {
        var _this = this;
        confirmActiveTransaction(this);
        if (key === null) {
          key = void 0;
      ...
      FDBIndex2.prototype.toString = function() {
        return "[object IDBIndex]";
      };
      return FDBIndex2;
    }();
    exports2.default = FDBIndex;
  }
});

// node_modules/fake-indexeddb/build/lib/canInjectKey.js
var require_canInjectKey = __commonJS({
  "node_modules/fake-indexeddb/build/lib/canInjectKey.js"(exports2) {
    "use strict";
    var __values = exports2 && exports2.__values || function(o) {
      var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
      if (m)
    ...
    var canInjectKey = function(keyPath, value) {
      ...
      try {
        ...
        try {
          if (identifiers_1_1 && !identifiers_1_1.done && (_a = identifiers_1.return))
    ...
    exports2.default = canInjectKey;
  }
});

// node_modules/fake-indexeddb/build/lib/binarySearch.js
var require_binarySearch = __commonJS({
  "node_modules/fake-indexeddb/build/lib/binarySearch.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var cmp_1 = require_cmp();
    ...
    exports2.getIndexByKey = getIndexByKey;
    function getByKey(records, key) {
      var idx = getIndexByKey(records, key);
      return records[idx];
    }
    exports2.getByKey = getByKey;
    ...
    exports2.getIndexByKeyRange = getIndexByKeyRange;
    function getByKeyRange(records, keyRange) {
      var idx = getIndexByKeyRange(records, keyRange);
      return records[idx];
    }
    exports2.getByKeyRange = getByKeyRange;
    ...
    exports2.getIndexByKeyGTE = getIndexByKeyGTE;
  }
});
...
var require_RecordStore = __commonJS({
  "node_modules/fake-indexeddb/build/lib/RecordStore.js"(exports2) {
    ...
    exports2.default = RecordStore;
  }
});

// node_modules/fake-indexeddb/build/lib/Index.js
var require_Index = __commonJS({
  "node_modules/fake-indexeddb/build/lib/Index.js"(exports2) {
    "use strict";
    var __values = exports2 && exports2.__values || function(o) {
      var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
      if (m)
      ...
      Index2.prototype.storeRecord = function(newRecord) {
        ...
        if (!this.multiEntry || !Array.isArray(indexKey)) {
          ...
          try {
            ...
            try {
              if (indexKey_1_1 && !indexKey_1_1.done && (_a = indexKey_1.return))
                _a.call(indexKey_1);
            } finally {
              if (e_3)
                throw e_3.error;
        ...
        if (!this.multiEntry || !Array.isArray(indexKey)) {
          ...
          if (this.unique) {
            try {
              ...
              try {
                if (indexKey_2_1 && !indexKey_2_1.done && (_b = indexKey_2.return))
                  _b.call(indexKey_2);
              } finally {
                if (e_4)
                  throw e_4.error;
        ...
        if (!this.multiEntry || !Array.isArray(indexKey)) {
          ...
          try {
            ...
            try {
              if (indexKey_3_1 && !indexKey_3_1.done && (_c = indexKey_3.return))
                _c.call(indexKey_3);
            } finally {
              if (e_5)
                throw e_5.error;
...
var require_validateKeyPath = __commonJS({
  "node_modules/fake-indexeddb/build/lib/validateKeyPath.js"(exports2) {
    "use strict";
    var __values = exports2 && exports2.__values || function(o) {
      var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
      if (m)
    ...
    exports2.default = validateKeyPath;
  }
});

// node_modules/fake-indexeddb/build/FDBObjectStore.js
var require_FDBObjectStore = __commonJS({
  "node_modules/fake-indexeddb/build/FDBObjectStore.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var FDBCursor_1 = require_FDBCursor();
    var FDBCursorWithValue_1 = require_FDBCursorWithValue();
    ...
    var FDBObjectStore = function() {
      function FDBObjectStore2(transaction, rawObjectStore) {
      ...
      Object.defineProperty(FDBObjectStore2.prototype, "name", {
        get: function() {
          return this._name;
        },
        set: function(name) {
      ...
      FDBObjectStore2.prototype.put = function(value, key) {
        if (arguments.length === 0) {
          throw new TypeError();
        }
      ...
      FDBObjectStore2.prototype.add = function(value, key) {
        if (arguments.length === 0) {
          throw new TypeError();
        }
        var record = buildRecordAddPut(this, value, key);
      ...
      FDBObjectStore2.prototype.delete = function(key) {
        if (arguments.length === 0) {
          throw new TypeError();
        }
        confirmActiveTransaction(this);
      ...
      FDBObjectStore2.prototype.get = function(key) {
        if (arguments.length === 0) {
          throw new TypeError();
        }
        confirmActiveTransaction(this);
      ...
      FDBObjectStore2.prototype.getAll = function(query, count) {
        if (arguments.length > 1 && count !== void 0) {
          count = enforceRange_1.default(count, "unsigned long");
        }
        confirmActiveTransaction(this);
      ...
      FDBObjectStore2.prototype.getKey = function(key) {
        if (arguments.length === 0) {
          throw new TypeError();
        }
        confirmActiveTransaction(this);
      ...
      FDBObjectStore2.prototype.getAllKeys = function(query, count) {
        if (arguments.length > 1 && count !== void 0) {
          count = enforceRange_1.default(count, "unsigned long");
        }
        confirmActiveTransaction(this);
      ...
      FDBObjectStore2.prototype.clear = function() {
        confirmActiveTransaction(this);
        if (this.transaction.mode === "readonly") {
          throw new errors_1.ReadOnlyError();
        }
      ...
      FDBObjectStore2.prototype.openCursor = function(range, direction) {
        confirmActiveTransaction(this);
        if (range === null) {
          range = void 0;
        }
      ...
      FDBObjectStore2.prototype.openKeyCursor = function(range, direction) {
        confirmActiveTransaction(this);
        if (range === null) {
          range = void 0;
        }
      ...
      FDBObjectStore2.prototype.createIndex = function(name, keyPath, optionalParameters) {
        var _this = this;
      ...
      FDBObjectStore2.prototype.index = function(name) {
        if (arguments.length === 0) {
          throw new TypeError();
        }
      ...
      FDBObjectStore2.prototype.deleteIndex = function(name) {
        var _this = this;
        if (arguments.length === 0) {
          throw new TypeError();
        }
      ...
      FDBObjectStore2.prototype.count = function(key) {
        var _this = this;
        confirmActiveTransaction(this);
        if (key === null) {
          key = void 0;
      ...
      FDBObjectStore2.prototype.toString = function() {
        return "[object IDBObjectStore]";
      };
      return FDBObjectStore2;
    }();
    exports2.default = FDBObjectStore;
  }
});

// node_modules/fake-indexeddb/build/lib/FakeEvent.js
var require_FakeEvent = __commonJS({
  "node_modules/fake-indexeddb/build/lib/FakeEvent.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var Event2 = function() {
      function Event3(type, eventInitDict) {
      ...
      Event3.prototype.stopImmediatePropagation = function() {
        this.propagationStopped = true;
        this.immediatePropagationStopped = true;
      };
      return Event3;
    }();
    exports2.default = Event2;
  }
});

// node_modules/fake-indexeddb/build/lib/scheduling.js
var require_scheduling = __commonJS({
  "node_modules/fake-indexeddb/build/lib/scheduling.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    ...
    exports2.queueTask = globals.setImmediate || getSetImmediateFromJsdom() || function(fn) {
...
var require_FDBTransaction = __commonJS({
  "node_modules/fake-indexeddb/build/FDBTransaction.js"(exports2) {
    "use strict";
    var __extends = exports2 && exports2.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var FDBTransaction = function(_super) {
      __extends(FDBTransaction2, _super);
      function FDBTransaction2(storeNames, mode, db) {
        var _this = _super.call(this) || this;
        _this._state = "active";
      ...
      FDBTransaction2.prototype._abort = function(errName) {
        var e_1, _a, e_2, _b;
        var _this = this;
        try {
      ...
      FDBTransaction2.prototype.abort = function() {
      ...
      FDBTransaction2.prototype.objectStore = function(name) {
      ...
      FDBTransaction2.prototype._execRequestAsync = function(obj) {
      ...
      FDBTransaction2.prototype._start = function() {
        this._started = true;
        var operation;
        var request;
      ...
      FDBTransaction2.prototype.commit = function() {
        if (this._state !== "active") {
          throw new errors_1.InvalidStateError();
        }
        this._state = "committing";
      };
      FDBTransaction2.prototype.toString = function() {
        return "[object IDBRequest]";
      };
      return FDBTransaction2;
    }(FakeEventTarget_1.default);
    exports2.default = FDBTransaction;
  }
});

// node_modules/fake-indexeddb/build/lib/KeyGenerator.js
var require_KeyGenerator = __commonJS({
  "node_modules/fake-indexeddb/build/lib/KeyGenerator.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var errors_1 = require_errors();
    ...
    exports2.default = KeyGenerator;
  }
});

// node_modules/fake-indexeddb/build/lib/ObjectStore.js
var require_ObjectStore = __commonJS({
  "node_modules/fake-indexeddb/build/lib/ObjectStore.js"(exports2) {
    "use strict";
    var __values = exports2 && exports2.__values || function(o) {
      var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
      if (m)
    ...
    exports2.default = ObjectStore;
  }
});

// node_modules/fake-indexeddb/build/FDBDatabase.js
var require_FDBDatabase = __commonJS({
  "node_modules/fake-indexeddb/build/FDBDatabase.js"(exports2) {
    "use strict";
    var __extends = exports2 && exports2.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var FDBDatabase = function(_super) {
      __extends(FDBDatabase2, _super);
      function FDBDatabase2(rawDatabase) {
        var _this = _super.call(this) || this;
      ...
      FDBDatabase2.prototype.createObjectStore = function(name, options) {
        var _this = this;
        if (options === void 0) {
          options = {};
        }
      ...
      FDBDatabase2.prototype.deleteObjectStore = function(name) {
        var _this = this;
        if (name === void 0) {
          throw new TypeError();
        }
      ...
      FDBDatabase2.prototype.transaction = function(storeNames, mode) {
        var e_1, _a;
        var _this = this;
        ...
        try {
          ...
          try {
            if (storeNames_1_1 && !storeNames_1_1.done && (_a = storeNames_1.return))
      ...
      FDBDatabase2.prototype.close = function() {
        closeConnection(this);
      };
      FDBDatabase2.prototype.toString = function() {
        return "[object IDBDatabase]";
      };
      return FDBDatabase2;
    }(FakeEventTarget_1.default);
    exports2.default = FDBDatabase;
  }
});

// node_modules/fake-indexeddb/build/FDBOpenDBRequest.js
var require_FDBOpenDBRequest = __commonJS({
  "node_modules/fake-indexeddb/build/FDBOpenDBRequest.js"(exports2) {
    "use strict";
    var __extends = exports2 && exports2.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var FDBOpenDBRequest = function(_super) {
      __extends(FDBOpenDBRequest2, _super);
      function FDBOpenDBRequest2() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.onupgradeneeded = null;
        _this.onblocked = null;
        return _this;
      }
      FDBOpenDBRequest2.prototype.toString = function() {
        return "[object IDBOpenDBRequest]";
      };
      return FDBOpenDBRequest2;
    }(FDBRequest_1.default);
    exports2.default = FDBOpenDBRequest;
  }
});

// node_modules/fake-indexeddb/build/FDBVersionChangeEvent.js
var require_FDBVersionChangeEvent = __commonJS({
  "node_modules/fake-indexeddb/build/FDBVersionChangeEvent.js"(exports2) {
    "use strict";
    var __extends = exports2 && exports2.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var FDBVersionChangeEvent = function(_super) {
      __extends(FDBVersionChangeEvent2, _super);
      function FDBVersionChangeEvent2(type, parameters) {
      ...
      FDBVersionChangeEvent2.prototype.toString = function() {
        return "[object IDBVersionChangeEvent]";
      };
      return FDBVersionChangeEvent2;
    }(FakeEvent_1.default);
    exports2.default = FDBVersionChangeEvent;
  }
});

// node_modules/fake-indexeddb/build/lib/Database.js
var require_Database = __commonJS({
  "node_modules/fake-indexeddb/build/lib/Database.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var scheduling_1 = require_scheduling();
...
var require_FDBFactory = __commonJS({
  "node_modules/fake-indexeddb/build/FDBFactory.js"(exports2) {
    "use strict";
    var __values = exports2 && exports2.__values || function(o) {
      var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
      if (m)
    ...
    var deleteDatabase = function(databases, name, request, cb) {
      ...
      try {
        ...
        try {
          ...
          try {
            if (openDatabases_1_1 && !openDatabases_1_1.done && (_a = openDatabases_1.return))
    ...
    var runVersionchangeTransaction = function(connection, version, request, cb) {
      ...
      try {
        ...
        try {
          if (openDatabases_2_1 && !openDatabases_2_1.done && (_a = openDatabases_2.return))
    ...
    var FDBFactory = function() {
      function FDBFactory2() {
        this.cmp = cmp_1.default;
        this._databases = /* @__PURE__ */ new Map();
      }
      FDBFactory2.prototype.deleteDatabase = function(name) {
        var _this = this;
      ...
      FDBFactory2.prototype.open = function(name, version) {
        var _this = this;
      ...
      FDBFactory2.prototype.databases = function() {
        var _this = this;
      ...
      FDBFactory2.prototype.toString = function() {
        return "[object IDBFactory]";
      };
      return FDBFactory2;
    }();
    exports2.default = FDBFactory;
  }
});

// node_modules/fake-indexeddb/build/fakeIndexedDB.js
var require_fakeIndexedDB = __commonJS({
  "node_modules/fake-indexeddb/build/fakeIndexedDB.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var FDBFactory_1 = require_FDBFactory();
    var fakeIndexedDB = new FDBFactory_1.default();
    exports2.default = fakeIndexedDB;
  }
});

// node_modules/fake-indexeddb/build/index.js
var require_build = __commonJS({
  "node_modules/fake-indexeddb/build/index.js"(exports2, module2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var fakeIndexedDB_1 = require_fakeIndexedDB();
    module2.exports = fakeIndexedDB_1.default;
  }
});

// node_modules/mock-socket/dist/mock-socket.js
var require_mock_socket = __commonJS({
  "node_modules/mock-socket/dist/mock-socket.js"(exports2, module2) {
    (function(global2, factory) {
      typeof exports2 === "object" && typeof module2 !== "undefined" ? factory(exports2) : typeof define === "function" && define.amd ? define(["exports"], factory) : factory(global2.Mock = global2.Mock || {});
      ...
      EventTarget2.prototype.addEventListener = function addEventListener(type, listener) {
      ...
      EventTarget2.prototype.removeEventListener = function removeEventListener(type, removingListener) {
        var arrayOfListeners = this.listeners[type];
        this.listeners[type] = reject(arrayOfListeners, function(listener) {
          return listener === removingListener;
        });
      };
      EventTarget2.prototype.dispatchEvent = function dispatchEvent(event) {
        var this$1 = this;
      ...
      var Event2 = function(EventPrototype$$1) {
        function Event3(type, eventInitConfig) {
        ...
        if (EventPrototype$$1)
          Event3.__proto__ = EventPrototype$$1;
        Event3.prototype = Object.create(EventPrototype$$1 && EventPrototype$$1.prototype);
        Event3.prototype.constructor = Event3;
        return Event3;
      }(EventPrototype);
      ...
      function createEvent(config) {
        ...
        var eventObject = new Event2(type);
        if (target) {
      ...
      var SocketIO = IO;
      exports3.Server = Server;
      exports3.WebSocket = WebSocket2;
      exports3.SocketIO = SocketIO;
...
var import_sync_fetch = __toESM(require_sync_fetch());
var import_cross_fetch = __toESM(require_node_ponyfill());
var import_fake_indexeddb = __toESM(require_build());
var import_mock_socket = __toESM(require_mock_socket());
...
module.exports = import_worker_threads.default.isMainThread ? mainThread() : workerThread();
...
function mainThread() {
  class Worker extends EventTarget {
    constructor(url, options) {
      ...
      const worker = new import_worker_threads.default.Worker(__filename, { workerData: { mod, name, type } });
    ...
    importScripts(...scripts) {
      ...
      for (const script of scripts) {
        ...
        if (script.indexOf("http") === 0) {
          try {
            code = (0, import_sync_fetch.default)(script).text();
          } catch (err) {
            console.error("remote file error:", err);
          }
        } else {
          code = import_fs.default.readFileSync(script, "utf-8").toString();
        }
        combined.push(code);
      }
      import_vm.default.runInThisContext(combined.join("\n"));
    }
    fetch = import_cross_fetch.default;
    indexedDB = import_fake_indexeddb.default;
    WebSocket = import_mock_socket.WebSocket;
  }
